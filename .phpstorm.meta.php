...
'datatables-buttons.generator.dom','filesystems.default','filesystems.disks.local.driver','filesystems.disks.local.root','filesystems.disks.local.serve',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/skdev/advice-crm/advice/public/storage','fortify.guard',
...
'broadcasting.connections.ably.driver','broadcasting.connections.ably.key','broadcasting.connections.log.driver','broadcasting.connections.null.driver','excel.exports.chunk_size',
...
'two-factor.secret-key','two-factor.recovery-codes','admin.dashboard','admin.societies.index','admin.societies.create',
'admin.societies.store','admin.societies.view','admin.societies.edit','admin.societies.update','admin.societies.remove',
'admin.societies.restore','properties.index','properties.create','properties.store','properties.show',
'properties.edit','properties.update','properties.destroy','admin.cities.index','admin.cities.create',
'admin.cities.store','admin.cities.view','admin.cities.edit','admin.cities.update','admin.cities.remove',
'admin.users','admin.settings','storage.local',);
        registerArgumentsSet('views', 
'admin.cities.create','admin.cities.edit','admin.cities.index','admin.components.seo-fields','admin.dashboard.index',
'admin.layouts.app','admin.partials.footer','admin.partials.loader','admin.partials.sidebar','admin.partials.switcher',
'admin.partials.topbar','admin.societies.create','admin.societies.edit','admin.societies.index','admin.societies.partials.actions',
'admin.societies.show','admin.starter','auth.login','auth.signup','datatables::print',
'datatables::print','properties','properties.create','properties.edit','properties.index',
'properties.show','vendor.datatables.print','welcome','datatables::editor','datatables::function',
...
'CACHE_STORE','FASTAPI_HOST','MEILI_HOST','MEILI_MASTER_KEY','MEMCACHED_HOST',
