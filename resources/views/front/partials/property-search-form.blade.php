{{-- property-search-form.blade.php --}}
<div
        x-data="propertySearch('{{ $type }}')"
        @submit.prevent="searchProperties"
>
    <form class="registration-form text-slate-900 text-start">
        <div class="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 lg:gap-0 gap-6">
            ...
            <div>
                ...
                <div class="filter-search-form relative filter-border mt-2">
                    ...
                    <select class="form-select z-2" name="category" id="choices-catagory-buy" x-model="search.category">
            ...
            <div>
                ...
                <div class="filter-search-form relative filter-border mt-2">
                    ...
                    <select class="form-select" name="min_price" id="choices-min-price-buy" x-model="search.min_price">
            ...
            <div>
                ...
                <div class="filter-search-form relative mt-2">
                    <i class="uil uil-usd-circle icons"></i>
                    <select class="form-select" name="max_price" id="choices-max-price-buy" x-model="search.max_price">
