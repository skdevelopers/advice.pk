...
<section class="container mx-auto mt-16"
    ...
    <div class="md:flex justify-center text-center mt-6">
        <div class="md:w-full">
            <a href="#" class="btn btn-link text-green-600 hover:text-green-600 after:bg-green-600 transition duration-500">View More Properties <i class="uil uil-arrow-right ms-1"></i></a>
        </div>
    </div>
